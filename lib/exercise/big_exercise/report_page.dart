...
class _ReportPageState extends State<ReportPage> {
  ...
  Widget build(BuildContext context) {
    ...
    print('so luong pt mh 2: ${cubitProvider.listReport}');
  ...
  Widget listViewNewFeed() {
    ...
    if (cubit.listReport.isNotEmpty) {
      return ListView.separated(
        itemBuilder: (context, index) {
          return BuildReport(
            newFeedModel: cubit.listReport[index],
          );
        },
        ...
        itemCount: cubit.listReport.length,
      );
    }
    return Container();
  }
              ...
              children: [
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: Image.asset('assets/icons/dog2.jpeg'),
                  ),
                ),
                const SizedBox(
                  width: 8,
